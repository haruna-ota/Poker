...
public class Main {
    public static void main(String[] args) {
        //手札を生成する
        //手札1:ロイヤルストレートフラッシュ
        List<Card> cards1 = new ArrayList<>(Arrays.asList(
        ...
        //手札2:ストレートフラッシュ
        List<Card> cards2 = new ArrayList<>(Arrays.asList(
        ...
        //手札3:4カード
        List<Card> cards3 = new ArrayList<>(Arrays.asList(
        ...
        //手札4:フルハウス
        List<Card> cards4 = new ArrayList<>(Arrays.asList(
        ...
        //手札5:フラッシュ
        List<Card> cards5 = new ArrayList<>(Arrays.asList(
        ...
        //手札6:ストレート
        List<Card> cards6 = new ArrayList<>(Arrays.asList(
                new Card(H, new Rank(9)),
        ...
        //手札7:3カード
        List<Card> cards7 = new ArrayList<>(Arrays.asList(
        ...
        //手札8:2ペア
        List<Card> cards8 = new ArrayList<>(Arrays.asList(
        ...
        //手札9:1ペア
        List<Card> cards9 = new ArrayList<>(Arrays.asList(
                new Card(H, new Rank(1)),
        ...
        //手札10:ハイカード
        List<Card> cards10 = new ArrayList<>(Arrays.asList(
                new Card(H, new Rank(1)),
