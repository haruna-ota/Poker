...
class HandTest extends Specification {
    ...
    def theNameOfHand() {
        ...
        where:
        cards                                             | exp
        [$(S, 1), $(S, 10), $(S, 11), $(S, 12), $(S, 13)] | "ロイヤルストレートフラッシュ"
        [$(H, 9), $(H, 10), $(H, 11), $(H, 12), $(H, 13)] | "ストレートフラッシュ"
        [$(H, 5), $(S, 5), $(C, 5), $(D, 5), $(D, 13)]    | "4カード"
        [$(S, 4), $(D, 4), $(H, 4), $(H, 11), $(D, 11)]   | "フルハウス"
        [$(H, 1), $(H, 2), $(H, 3), $(H, 4), $(H, 5)]     | "フラッシュ"
        [$(H, 9), $(D, 10), $(S, 11), $(H, 12), $(C, 13)] | "ストレート"
        [$(C, 1), $(H, 1), $(D, 1), $(S, 10), $(H, 12)]   | "3カード"
        [$(D, 3), $(H, 3), $(H, 5), $(S, 11), $(C, 11)]   | "2ペア"
        [$(H, 1), $(S, 8), $(C, 8), $(D, 12), $(H, 13)]   | "1ペア"
        [$(H, 1), $(S, 2), $(D, 3), $(C, 4), $(D, 5)]     | "ハイカード"
    }
